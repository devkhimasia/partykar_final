...
<link rel="stylesheet" href="css/vallenato.css" type="text/css">
  ...
  <div class="topHeader">
    ...
    <div id="topMenu">
      <ul id="trans-nav">
        ...
        <li><a href="categories.php" target="_self" title="Partykar.com" id="topActive">Categories</a>
        <ul>            
...
<div class="mainWrap">
  <div class="pagePath"><a href="index.php" class="linkHome">Home</a> <span class="pathArrow">></span> <span class="headingOrangeSmall">Categories</span></div>
  <div class="vloginForm">
        
    <div class="pkBenInfo"> <span class="careersHeading">Below is a list of Categories that Partykar caters to :
    </span><br><br>
      <p class="bodyText">
      
        <div class="catPointBlock">
       <a href="set_search_session.php?c=any&a=any&cat=caterer"><div class="catPoint">
        <span class="careersHeading">CATERER</span><br><br>
        <img src="images/categories/CATERERS.jpg" /><br><br>        
        
        </div></a>
         <a href="set_search_session.php?c=any&a=any&cat=photographer"><div class="catPoint">
        <span class="careersHeading">Photographer</span><br><br>        
        <img src="images/categories/Photographers.jpg" /><br><br>        
        
        </div></a>
         <a href="set_search_session.php?c=any&a=any&cat=Choreographer"><div class="catPoint">
        <span class="careersHeading">Choreographer</span><br><br>        
        <img src="images/categories/choreographers.jpg" /><br><br>        
        </div></a>
         <!--<a href="set_search_session.php?c=any&a=any&cat=event / wedding planner">
         <div class="catPoint">
        <span class="careersHeading">Event / Wedding Planner</span><br><br>
        <img src="images/categories/event-wedding-planners.jpg" /><br><br>        
        
        </div></a>-->
         <a href="set_search_session.php?c=any&a=any&cat=Tatoo"><div class="catPoint">
        <span class="careersHeading">Tatoo</span><br><br>        
        <img src="images/categories/tatoo-artists.jpg" /><br><br>        
        </div></a>
        
         <a href="set_search_session.php?c=any&a=any&cat=Magician"><div class="catPoint">
        <span class="careersHeading">Magician</span><br><br>
        <img src="images/categories/magicians.jpg" /><br><br>        
        
        <!--<li>non-veg</li>
        <li>marwari/jain cuisine</li>
        <li>south indian</li>
        <li>wedding</li>
        <li>corporate</li>
        <li>small parties 25-50</li>
        <li>upto 100 persons</li>
        <li>upto 300 persons</li>
        <li>500 and above persons</li>
        <li>sweets</li>
        <li>snacks</li>
        <li>hire party cooks</li>-->
       
        </div></a>
        </div>
        
        <div class="catPointCenterBlock">        
         <a href="set_search_session.php?c=any&a=any&cat=caterer"><div class="catPoint">
        <span class="careersHeading">Makeup Artists</span><br><br>        
        <img src="images/categories/make-parlours.jpg" /><br><br>        
        
        </div></a>
         <a href="set_search_session.php?c=any&a=any&cat=Musician"><div class="catPoint">
        <span class="careersHeading">Musician</span><br><br>        
        <img src="images/categories/musician.jpg" /><br><br>        
        </div></a>
         <a href="set_search_session.php?c=any&a=any&cat=Fashion Designer"><div class="catPoint">
        <span class="careersHeading">Fashion Designer</span><br><br>        
        <img src="images/categories/Fashion-Designers.jpg" /><br><br>        
        
        </div></a>
         <a href="set_search_session.php?c=any&a=any&cat=Decorator"><div class="catPoint">
        <span class="careersHeading">Decorator</span><br><br>
        <img src="images/categories/decorators.jpg" /><br><br>        
        
        </div></a>
         <a href="set_search_session.php?c=any&a=any&cat=Compere"><div class="catPoint">
        <span class="careersHeading">Compere</span><br><br>        
        <img src="images/categories/compering.jpg" /><br><br>        
       
        </div></a>
        </div>
        
        <div class="catPointBlock">
         <a href="set_search_session.php?c=any&a=any&cat=Singer"><div class="catPoint">
        <span class="careersHeading">Singer</span><br><br>
        <img src="images/categories/singers.jpg" /><br><br>        
       
        </div></a>
         <a href="set_search_session.php?c=any&a=any&cat=Banquet"><div class="catPoint">
        <span class="careersHeading">Banquet</span><br><br>        
        <img src="images/categories/Banquets.jpg" /><br><br>        
        
        </div></a>
         <a href="set_search_session.php?c=any&a=any&cat=Mehendi"><div class="catPoint">
        <span class="careersHeading">Mehendi</span><br><br>        
        <img src="images/categories/mehendi.jpg" /><br><br>        
       </div></a>
         <a href="set_search_session.php?c=any&a=any&cat=Clubs/ Lounge"><div class="catPoint">
        <span class="careersHeading">Clubs/Lounge</span><br><br>        
        <img src="images/categories/clubs-lounge.jpg" /><br><br>        
       </div></a>
         <a href="set_search_session.php?c=any&a=any&cat=Mimicry"><div class="catPoint">
        <span class="careersHeading">Mimicry</span><br><br>        
        <img src="images/categories/mimicry.jpg" /><br><br>        
