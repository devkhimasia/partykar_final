...
<div class="mainWrap">
  <div class="pagePath"><a href="index.php" class="linkHome">Home</a> <span class="pathArrow">></span> <span class="headingOrangeSmall">Disclaimer</span></div>
  <div class="vloginForm">
        
    <div class="pkBenInfo"> <span class="headingOrangeSmall2">Disclaimer</span><br>
      <p class="bodyText">Partykar is a platform that Users utilize to find vendors and customers and interact with one another for their transactions. We are not a party to such interaction nor do we control such interaction in any manner and as such we take no liability that arises from any such communication or transaction between users.<br><br>
      
      Partykar shall not be responsible for any claims arising out of such communications or transactions and shall not be responsible nor liable to mediate or resolve any disputes or disagreements between the Customers and the Vendors. Vendor and Customer shall settle all such disputes without involving Partykar in any manner.</p>
