...
<script src="js/contactus-validation.js" language="javascript" type="text/javascript"></script>
  ...
  <div class="topHeader">
    ...
    <div id="topMenu">
      <ul id="trans-nav">
        ...
        <li><a href="contact.php" target="_self" title="Partykar.com" id="topActive">Get in Touch</a></li>
      </ul>
    </div>
  </div>
</div>
...
<div class="mainWrap">
  <div class="pagePath"><a href="index.php" class="linkHome">Home</a> <span class="pathArrow">></span> <span class="headingOrangeSmall">Get in touch</span></div>
  <div class="vloginForm">
    <div class="pkBenInfo">
      <div class="enquiryForm">
      <span class="linkHome">Please feel free to get in touch with us using the enquiry form below for any general questions or queries that you may have regarding partykar and we will get back to you at the earliest.</span><br><br>
        <form method="post" action="submit.php" onSubmit="return validate_form(this);" name="enquiryForm">
          <input name="name" id="name" class="inputTxt" placeholder="Your Name">
          <font color="red">*</font>
          <input name="email" type="text" id="email" class="inputTxt" placeholder="Your E-mail">
          <font color="red">*</font>
          <input name="phone" type="text" id="phone" class="inputTxt" placeholder="Your Mobile Number" maxlength="10">
          <font color="red">*</font>
          <input name="city" type="text" id="city" class="inputTxt" placeholder="Enter your City">
          <textarea name="message" id="message" cols="" rows="" placeholder="Write your requirment" class="inputMessage"></textarea>
          <input type="submit" value="Submit" class="submit" name="btnsubmit"/>
        </form>
      </div>
      
      <div class="enquiryFormRt">
     If you are an artist<br>or a vendor join<br>
        <h3>The<br>
        Partykar<br>
        Experience</h3>
        Click the button below<br>
        to register yourself <br>
        as a vendor<br><br>
        <a href="vendor-registration.php" class="regBtn radius5">Join Partykar</a>
      </div>
      <div class="clr"></div>
    </div>
  </div>
