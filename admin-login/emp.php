...
function filter(alpha)
{
	...
	{
	window.location="emp.php?alpha="+alpha;
	}
}
function search1()
{
	var name=document.getElementById('search').value;
	window.location="emp.php?search="+name;
...
<div class="mainH_strip gradientGray boxShadow">
    ...
    <a href="emp.php" target="_self" class="active">VIEW EMPLOYEES</a> 
    <a href="add_emp.php" target="_self">ADD EMPLOYEES</a> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_full" id="main_tab">
  <tr>
    <td class="w20 tdBlock mainHeading">Name&nbsp;<img src="images/down-arrow.png" /></td>
    <td class="w20 tdBlock mainHeading">Designation&nbsp;<img src="images/down-arrow.png" /></td>
    <td class="w20 tdBlock mainHeading">DOJ&nbsp;<img src="images/down-arrow.png" /></td>
    <td class="w20 tdBlock mainHeading">PF NO.&nbsp;<img src="images/down-arrow.png" /></td>
    <td class="w20 tdBlock mainHeading">GROSS&nbsp;<img src="images/down-arrow.png" /></td>
  ...
  $data=mysql_query("select * from employees",$db_con);
	}
	else
	{
	...
	{
		$alpha=$_GET['alpha'];
		 $data=mysql_query("select * from employees where name like '$alpha%'",$db_con);
	}
	else
	{
		$search=$_GET['search'];
		 $data=mysql_query("select * from employees where name like like '%$search%'",$db_con);
	}
	}
  while ($row=mysql_fetch_row($data))
  {
	...
	<td class='w20 tdBlock vinfotab'>$row[5]</td>
  </tr>
  ";
  }
  ?>
