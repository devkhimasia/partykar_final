...
{
	$res=mysql_query ("select id,vendor,category,position,start_date,end_date from ads where end_date > CURDATE() order by category",$db_con);
}
else
{
...
<div class="mainH_strip gradientGray boxShadow">
    ...
    <a href="view_ads.php" target="_self"  class="active">VIEW ADS</a>
