...
function filter(alpha)
{
	...
	if(alpha=='none')
	{
		window.location="lost_vendors.php";
	}
	else
	{
	window.location="lost_vendors.php?alpha="+alpha;
	}
}
function search1()
{
	var name=document.getElementById('search').value;
	window.location="lost_vendors.php?search="+name;
...
<div class="mainH_strip gradientGray boxShadow">
    ...
    <a href="lost_vendors.php" target="_self" class="active">LOST VENDORS</a>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_full" id="main_tab">
  <tr>
    ...
    <td class="w14 tdBlock mainHeading">Category&nbsp;<img src="images/down-arrow.png" /></td>
    <td class="w13 tdBlock mainHeading">Location&nbsp;<img src="images/down-arrow.png" /></td>
    <td class="w12 tdBlock mainHeading">Mem. Type&nbsp;<img src="images/down-arrow.png" /></td>
    <td class="w12 tdBlock mainHeading">Mem. period&nbsp;<img src="images/down-arrow.png" /></td>
    <td class="w8 tdBlock mainHeading">Cost&nbsp;<img src="images/down-arrow.png" /></td>
    <td class="w13 tdBlock mainHeading">Act. Date&nbsp;<img src="images/down-arrow.png" /></td>
    <td class="w13 tdBlock mainHeading">Expiry Date&nbsp;<img src="images/down-arrow.png" /></td>
    </tr>
    <?php
	require ("db.php");
	if(!isset($_GET['alpha']) and !isset($_GET['search']))
	{
	$res=mysql_query("select a.company,b.category,b.area,b.membership_type,b.membership_period,b.price,b.doa,b.doe,b.vendor_id from vendor a,vendor_category b where a.id=b.vendor_id and datediff(doe,CURDATE())<0 and renewed!='yes' and membership_type!='free'",$db_con);
	}
	else
	{
		...
		{
	$alpha=$_GET['alpha'];
	$res=mysql_query("select a.company,b.category,b.area,b.membership_type,b.membership_period,b.price,b.doa,b.doe,b.vendor_id from vendor a,vendor_category b where a.id=b.vendor_id and datediff(doe,CURDATE())<0 and renewed!='yes' and membership_type!='free' and a.company like '$alpha%'",$db_con);
		}
		else
		{
			$search=$_GET['search'];
	$res=mysql_query("select a.company,b.category,b.area,b.membership_type,b.membership_period,b.price,b.doa,b.doe,b.vendor_id from vendor a,vendor_category b where a.id=b.vendor_id and datediff(doe,CURDATE())<0 and renewed!='yes' and membership_type!='free' and a.company like '%$search%'",$db_con);
		}
	}
	while ($row=mysql_fetch_row($res))
	{
		echo "
		 <tr>
    	<td class='w15 tdBlock vinfotab'><a class='block1 fancybox.iframe'  href='popup_data.php?id=$row[8]'>$row[0]</a></td>
    	<td class='w14 tdBlock vinfotab'>$row[1]</td>
    	<td class='w13 tdBlock vinfotab'>$row[2]</td>
    	<td class='w12 tdBlock vinfotab'>$row[3]</td>
   	 	<td class='w12 tdBlock vinfotab'>$row[4]</td>
   	 	<td class='w8 tdBlock vinfotab'>$row[5]</td>
    	<td class='w13 tdBlock vinfotab'>$row[6]</td>
    	<td class='w13 tdBlock vinfotab'>$row[7]</td>
    	</tr>
		";
	}
	?>
