...
<script>
 $(document).ready(function() {
	...
	$("#mobile2").keydown(function (e) {
        ...
        if ($.inArray(e.keyCode, [46, 8, 9, 27, 13, 110, 190]) !== -1 ||
             // Allow: Ctrl+A
            (e.keyCode == 86 && e.ctrlKey === true) || (e.keyCode == 65 && e.ctrlKey === true) || (e.keyCode == 67 && e.ctrlKey === true) || (e.keyCode == 88 && e.ctrlKey === true) ||// Allow: home, end, left, right
            (e.keyCode >= 35 && e.keyCode <= 39)) {
                 // let it happen, don't do anything
				//document.getElementById("only_no").style.display='none';
                 return;
...
function store()
{
	...
	var category = str2.options[str2.selectedIndex].value;
	...
	ajaxRequest.onreadystatechange = function(){
		if(ajaxRequest.readyState == 4){
			...
			{
				alert("Vendor Update Sucessfully");
...
source: availableTags
			...
			<tr>
              ...
              <td class="fGap">:</td>
              <td class="inputBoxBlock"><input name="website" type="text" class="inputType" id="website" maxlength="50" value="<?php echo $row['website']; ?>"></td>
            </tr>
            <tr>
              <td colspan="3" height="10"></td>
            </tr>
