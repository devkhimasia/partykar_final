...
<div class="mainH_strip gradientGray boxShadow">
    ...
    <a href="add_cat.php" target="_self" class="active">ADD CATEGORY</a> 
...
<div class="gridFull">
<center>
<form id="save_new_cat" action="save_cat.php" method="post">
<table width="300">
<tr>
<td width="50">
Category:
...
<td width="250">
<input type="text" name="cat" id="cat" class="selectBoxMain2">
</td>
</tr>
<tr>
<td>
...
<td>
<textarea name="keys" id="keys" class="selectBoxMain2"></textarea>
</td>
</tr>
<tr>
<td>
...
<option value="1">Ustad</option>
<option value="2">Shandaar</option>
<option value="3">Kalakar</option>
</select>
</td>
</tr>
<tr>
...
Category: <input type="text" name="area" id="area_edit" value="<?php if(isset($_GET['cat'])) echo $_GET['cat']; ?>" class="areaAuto selectBoxMain1">
...
<?php 
require('db.php');
$area=mysql_query("select distinct category from category",$db_con);
...
<table width="25%" border="0" cellspacing="0" cellpadding="0" class="tab_full" id="main_tab">
  <tr>
    <td class="w25 tdBlock mainHeading">Category&nbsp;<img src="images/down-arrow.png" /></td>
  
  </tr>
  <?php
 
	  $area=$_GET['cat'];
  $res=mysql_query("select id,category from category where category like '%$area%'",$db_con);
 while ($row=mysql_fetch_row($res))
 {
	 echo " <tr>
    
   
	<td class='w5 tdBlock vinfotab'>$row[1]</td>
	<td align='left' class='w5 tdBlock vinfotab'><a class='mainHeading' href='edit_cat_data.php?id=$row[0]'><strong>EDIT</strong></a></td>
	</tr>";
 }
  }
 ?>
