...
{
	$res=mysql_query ("select * from leads",$db_con);
}
else
{
	...
	{
	$alpha=$_GET['alpha'];
	$res=mysql_query ("select * from leads where name like '$alpha%'",$db_con);
	}
	else
	{
	$search=$_GET['search'];
	$res=mysql_query ("select * from leads where ref_code like '$search%'",$db_con);
	}
}
}
else
...
function filter(alpha)
{
	...
	{
	window.location="leads.php?alpha="+alpha;
	}
}
function search1()
{
	var name=document.getElementById('search').value;
	window.location="leads.php?search="+name;
...
<div class="mainH_strip gradientGray boxShadow">
    ...
    <a href="lost_vendors.php" target="_self">LOST VENDORS</a>
     <a href="leads.php" target="_self" class="active">LEADS</a>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_full" id="main_tab">
  <tr>
    <td class="w12 tdBlock mainHeading">Name&nbsp;<img src="images/down-arrow.png" /></td>
    <td class="w12 tdBlock mainHeading">City&nbsp;<img src="images/down-arrow.png" /></td>
    ...
    <td class="w12 tdBlock mainHeading">Email&nbsp;<img src="images/down-arrow.png" /></td>
    <td class="w12 tdBlock mainHeading">Date&nbsp;<img src="images/down-arrow.png" /></td>
    <td class="w16 tdBlock mainHeading">Code&nbsp;<img src="images/down-arrow.png" /></td>
  </tr>
 ...
 {
	 echo " <tr>
    <td class='w12 tdBlock vinfotab'>$row[1]</td>
    <td class='w12 tdBlock vinfotab'>$row[2]</td>
    <td class='w12 tdBlock vinfotab'>$row[3]</td>
    <td class='w12 tdBlock vinfotab'>$row[4]</td>
    <td class='w12 tdBlock vinfotab'>$row[5]</td>
    <td class='w12 tdBlock vinfotab'>$row[6]</td>
    <td class='w12 tdBlock vinfotab'>$row[8]</td>
	<td class='w16 tdBlock vinfotab'>$row[10]</td>
