...
<div class="mainWrap">
  <div class="pagePath"><a href="index.php" class="linkHome">Home</a> <span class="pathArrow">></span> <span class="headingOrangeSmall"> How can you benefit from Partykar?</span></div>
  <div class="vloginForm">
        
    <div class="pkBenInfo"> <span class="headingOrangeSmall2"> How can you benefit from Partykar?</span><br>
      <p class="bodyText">Gone are the days where you could rely solely on word of mouth to reach your customers.  In fragmented market and cut throat competition Partykar helps you identify your business opportunities at the fastest.<br><br>
        
It makes the unknowns known and the knowns bigger.It provides you the privilege to endorse, build your brand image and bring your brand to life. It also gives you a technological marketing edge over your competition. 

Simply register and be the part of Partykar family.<br><br>

Partykar also offers <span style="color:#06F; font-weight:bold;">subscription</span> and <span style="color:#06F; font-weight:bold;">advertising</span> packages to best suit your business.
</p>
