...
$(document).ready(function(){
        ...
        $("a#q").hover(function (e) 
        {
                e.preventDefault();
            $("#" + $(this).attr("class")).show().siblings('.faqBlock2').hide();
			//$(this).addClass("adTabAct").siblings('.adTabAct').removeClass();
			$('li a.adTabAct').removeClass('adTabAct');
    		$(this).addClass('adTabAct');
        });
...
<div class="mainWrap">
  <div class="pagePath"><a href="index.php" class="linkHome">Home</a> <span class="pathArrow">></span> <span class="headingOrangeSmall">Advertising with us</span></div>
  <div class="vloginForm">
        
    <div class="pkBenInfo"> 
    <div class="devmenu2">
    <ul>
    <li><a href="#" class="faq1" id="q"><span class="adTab">Leads</span></a></li>
    <li><a href="#" class="faq2" id="q"><span class="adTab2">Brand<br>Building</span></a></li>
    <li><a href="#" class="faq3" id="q"><span class="adTab2">Closer to<br>Customers</span></a></li>
    <li><a href="#" class="faq4" id="q"><span class="adTab">Dynamic</span></a></li>
    <li><a href="#" class="faq5" id="q"><span class="adTab2">One Step<br>Ahead</span></a></li>
    </ul>
    </div>
    <div class="clr20"></div>
    <div class="faqBlock2" id="faq1">No relying on "word of mouth" in fragmented market and cut throat competition</div>    
    <div class="faqBlock2" id="faq2" style="display:none;">Reach customers at the comfort of your fingertips</div>
    <div class="faqBlock2" id="faq3" style="display:none;">Makes the unknowns known and the known bigger</div>
    <div class="faqBlock2" id="faq4" style="display:none;">Identify business opportunities at the fastest</div>
    <div class="faqBlock2" id="faq5" style="display:none;">Technological marketing edge over your competition</div>
    <div class="clr20"></div>
    <p class="bodyText">Simply register and be a part of Partykar family.<br>
    
    Partykar also offers <strong>subscription</strong> and <strong>advertising</strong> packages to best suit your business.<br>
    Reach us at <a href="mailto:vendors@partykar.com">Vendors@Partykar.com</a>
    </p>
      </div>
